...
PRODUCT_PACKAGES += \
    ...
    GlanceableHubConfigOverlayGs101 \
    GlanceableHubSettingsConfigOverlayGs101 \
    GlanceableHubSysuiConfigOverlayGs101 \
    GoogleConfigOverlayGs101 \
    GooglePermissionControllerSafetyCenterOverlay \
    PixelConfigOverlay2019Gs101 \
    PixelConfigOverlay2021Gs101 \
    PixelConfigOverlayCommonGs101 \
...
PRODUCT_COPY_FILES += \
    device/google/gs101/configs/axion/ax_perf_boosts.xml:$(TARGET_COPY_OUT_VENDOR)/etc/ax_perf_boosts.xml \
    device/google/gs101/configs/axion/ax_perf_resources.xml:$(TARGET_COPY_OUT_VENDOR)/etc/ax_perf_resources.xml \
    device/google/gs101/configs/axion/ax_perf_thermal.xml:$(TARGET_COPY_OUT_VENDOR)/etc/ax_perf_thermal.xml \
    device/google/gs101/configs/axion/ax_perf_threads.xml:$(TARGET_COPY_OUT_VENDOR)/etc/ax_perf_threads.xml \
    device/google/gs101/configs/axion/init.axion.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/init.axion.rc
